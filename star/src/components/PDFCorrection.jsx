...
export const PDFCorrection = () => {
  ...
  const apiTitles = ['"The window configuration may use passive venting to minimize potential surface contamination by material offgassing or moisture condensation."',
  '"This Standard primarily addresses structural design requirements for glass and ceramics, it also includes design and verification requirements for non-structural glass and ceramic components."',
...
const apiText = ['The report should explain the potential risks or drawbacks of passive venting, as there may be negative effects on the structural integrity or performance of the windows.',
'The report is not clear on what these non-structural components are. It would be helpful to provide examples or further clarification to ensure comprehensive understanding.',
'The report should provide more information on the possible consequences or risks associated with dynamic amplification of the load in the event of a pressure pane failure.']
